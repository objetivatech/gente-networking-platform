    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="member" className="space-y-4">
        <TabsList className="grid w-full grid-cols-3">
          ...
          {isAdmin && <TabsTrigger value="dev">Desenvolvimento</TabsTrigger>}
        </TabsList>

        {/* Documentação para Membros */}
          ...
          <ScrollArea className="h-[calc(100vh-300px)]">
            <div className="space-y-6 pr-4">
              ...
              <Card>
                ...
                <CardContent className="prose dark:prose-invert max-w-none">
                  <p>Convide novos membros para a comunidade.</p>
                  <ul>
            ...
            <ScrollArea className="h-[calc(100vh-300px)]">
              <div className="space-y-6 pr-4">
                ...
                <Card>
                  ...
                  <CardContent className="prose dark:prose-invert max-w-none">
                    ...
                    <ul>
                      ...
                      <li>Admins e facilitadores têm permissões elevadas</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid gap-2 text-sm font-mono">
                      <code className="p-2 rounded bg-muted">SUPABASE_URL</code>
                      <code className="p-2 rounded bg-muted">SUPABASE_PUBLISHABLE_KEY</code>
                      <code className="p-2 rounded bg-muted">SUPABASE_SERVICE_ROLE_KEY</code>
                      <code className="p-2 rounded bg-muted">RESEND_API_KEY</code>
                      <code className="p-2 rounded bg-muted">RD_STATION_API_KEY</code>
                    </div>
                  </CardContent>
                </Card>
              </div>
