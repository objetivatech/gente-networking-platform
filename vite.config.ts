  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Gente",
        description: "Sistema de gestão da comunidade Gente Networking. Conectando pessoas, gerando negócios.",
        theme_color: "#1e3a5f",
        ...
        shortcuts: [
          {
            name: "Gente em Ação",
            short_name: "Reuniões",
            description: "Registrar reuniões 1-a-1",
            url: "/gente-em-acao",
          ...
          },
          {
            ...
            description: "Gerenciar indicações",
            url: "/indicacoes",
            icons: [{ src: "/icons/icon-96x96.png", sizes: "96x96" }]
          }
        ]
